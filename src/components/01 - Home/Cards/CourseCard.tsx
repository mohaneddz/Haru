...
export default function CourseCard(props: Props) {
  ...
  return (
    <Tooltip 
      ...
      class="block"
    >
      <a class="p-0.25 bg-gradient-to-br from-border-light-2 to-border-dark-2 rounded-lg shadow-md hover:shadow-lg transition duration-100 hover:scale-105 cursor-pointer active:scale-100 overflow-hidden block"
