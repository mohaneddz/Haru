    ...
    return (
        <LayoutCard hoverable={false} class="p-6 border rounded-2xl shadow-xl bg-background-dark-1 text-white flex flex-col gap-4">
            ...
            <div class="flex gap-2 w-full">
                <a href={`/practice/training/flashcards/${props.id}`} class="text-center bg-accent w-full hover:scale-103 hover:bg-accent-dark-1 transition-all duration-75 hover:cursor-pointer p-1 rounded">Start</a>
                <a href={`/practice/training/flashcards/${props.id}`} class="text-center bg-sidebar-light-3 w-full hover:scale-103 hover:bg-sidebar-light-1 transition-all duration-75 hover:cursor-pointer p-1 rounded">Edit</a>
            </div>
