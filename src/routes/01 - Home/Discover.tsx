...
export default function Discover() {
  return (
    <div class="flex flex-col items-center justify-start h-screen w-full overflow-y-scroll pt-[20vh]">
      ...
      <CourseSeperator title='Mathematics' description='Explore our courses' />
      ...
      <CourseSeperator title='UI/UX' description='Explore our courses' />
